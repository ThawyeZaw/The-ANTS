 ...
 * - days_of_week: for weekly recurrence — which days (0=Sun to 6=Sat)
...
export interface TimetableEvent {
  ...
  /** Hex colour code overriding the default type colour */
  color_code: string;
...
if (!content.includes('TimetableEvent')) {
  fs.writeFileSync(typesPath, content + timetableTypes, 'utf8');
  console.log('SUCCESS: Timetable types appended to index.ts');
} else {
  console.log('SKIP: Timetable types already present in index.ts');
}
