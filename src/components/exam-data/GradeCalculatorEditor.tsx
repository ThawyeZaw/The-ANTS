    ...
    <div className="bg-[var(--background-secondary)] border border-[var(--border)] rounded-3xl p-6 md:p-8 shadow-xl">
      ...
      {currentStep === 1 && (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex justify-end gap-3 pt-4"><button type="button" onClick={() => setCurrentStep(2)} disabled={!canGoStep2} className="flex items-center gap-2 rounded-xl bg-primary px-5 py-3 text-xs font-medium text-primary-foreground shadow-lg disabled:opacity-40 disabled:cursor-not-allowed transition-all">Next: Papers <ArrowRight className="w-3.5 h-3.5" /></button></div>
        </div>
      )}
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="rounded-3xl border border-[var(--border)] bg-[var(--background-card)] p-5">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-5 border-b border-[var(--border)] pb-4">
              <div><h4 className="text-lg font-semibold text-[var(--foreground)] flex items-center gap-2"><BarChart3 className="w-4 h-4 text-primary" />Component Blueprint</h4><p className="text-xs text-[var(--foreground-secondary)]">{isModular ? 'Units with group labels.' : 'Papers with weights.'}</p></div>
          ...
          <div className="flex justify-between gap-3 pt-4">
            <button type="button" onClick={() => setCurrentStep(1)} className="flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--background-secondary)] px-5 py-3 text-xs font-medium text-[var(--foreground)] transition hover:bg-[var(--background-card)]"><ArrowLeft className="w-3.5 h-3.5" /> Back</button>
            <button type="button" onClick={() => setCurrentStep(3)} className="flex items-center gap-2 rounded-xl bg-primary px-5 py-3 text-xs font-medium text-primary-foreground shadow-lg transition-all">Next: Boundaries <ArrowRight className="w-3.5 h-3.5" /></button>
          </div>
        </div>
      )}
      ...
      {currentStep === 3 && (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="rounded-3xl border border-[var(--border)] bg-[var(--background-card)] p-5">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-5 border-b border-[var(--border)] pb-4">
              <div><h4 className="text-lg font-semibold text-[var(--foreground)]">Overall Grade Boundaries</h4><p className="text-xs text-[var(--foreground-secondary)]">Per-paper boundaries are already set on papers (Step 2).</p></div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-4">
            <button type="button" onClick={() => setCurrentStep(2)} className="flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--background-secondary)] px-5 py-3 text-xs font-medium text-[var(--foreground)] transition hover:bg-[var(--background-card)]"><ArrowLeft className="w-3.5 h-3.5" /> Back</button>
            <button type="button" onClick={handleSubmit} disabled={isPending} className="flex items-center gap-2 rounded-xl bg-primary px-5 py-3 text-xs font-medium text-primary-foreground shadow-lg transition-opacity disabled:opacity-70"><Send className="w-4 h-4" />{isPending ? 'Submitting...' : 'Submit for Review'}</button>
          </div>
