...
import CurriculumLibraryAdmin from '@/components/editor/CurriculumLibraryAdmin';
    ...
    return (
      <div className="flex min-h-[50vh] flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 max-w-sm text-sm text-foreground-muted">
          The Curriculum Library is available to Contributors and Main Contributors only.
        </p>
      </div>
    );
  }
