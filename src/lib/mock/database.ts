...
export const mockSubjects = [
  ...
  { id: 'subj-cie-chemistry', curriculum_id: 'curr-igcse-cie', title: 'Chemistry', description: 'Cambridge IGCSE Chemistry 0620 — particles, bonding, stoichiometry, organic, physical, inorganic chemistry.', order_no: 6 },
  { id: 'subj-cie-add-maths', curriculum_id: 'curr-igcse-cie', title: 'Additional Mathematics', description: 'Cambridge IGCSE Additional Mathematics 0606 — functions, quadratics, calculus, trigonometry, vectors.', order_no: 7 },
  { id: 'subj-cie-english-fl', curriculum_id: 'curr-igcse-cie', title: 'English (First Language)', description: 'Cambridge IGCSE English First Language 0500 — reading comprehension, directed writing, summary, narrative & descriptive writing.', order_no: 8 },
  { id: 'subj-cie-english-lit', curriculum_id: 'curr-igcse-cie', title: 'English Literature', description: 'Cambridge IGCSE English Literature 0486 — poetry, prose, drama, unseen texts, literary analysis.', order_no: 9 },
  { id: 'subj-cie-business', curriculum_id: 'curr-igcse-cie', title: 'Business Studies', description: 'Cambridge IGCSE Business Studies 0450 — marketing, operations, finance, HR, external influences.', order_no: 10 },
  { id: 'subj-cie-accounting', curriculum_id: 'curr-igcse-cie', title: 'Accounting', description: 'Cambridge IGCSE Accounting 0452 — double-entry, financial statements, ratios, costing, budgeting.', order_no: 11 },
  { id: 'subj-cie-geography', curriculum_id: 'curr-igcse-cie', title: 'Geography', description: 'Cambridge IGCSE Geography 0460 — population, settlement, natural environments, economic development.', order_no: 12 },
  { id: 'subj-cie-history', curriculum_id: 'curr-igcse-cie', title: 'History', description: 'Cambridge IGCSE History 0470 — 20th century international relations, depth studies, source analysis.', order_no: 13 },
  { id: 'subj-cie-ict', curriculum_id: 'curr-igcse-cie', title: 'ICT', description: 'Cambridge IGCSE Information & Communication Technology 0417 — hardware, software, networks, data, applications, systems life cycle.', order_no: 14 },
  { id: 'subj-cie-french', curriculum_id: 'curr-igcse-cie', title: 'French', description: 'Cambridge IGCSE French (Foreign Language) 0520 — reading, writing, listening, speaking, grammar, vocabulary.', order_no: 15 },
  { id: 'subj-cie-spanish', curriculum_id: 'curr-igcse-cie', title: 'Spanish', description: 'Cambridge IGCSE Spanish (Foreign Language) 0530 — reading, writing, listening, speaking, grammar, vocabulary.', order_no: 16 },
  { id: 'subj-cie-art-design', curriculum_id: 'curr-igcse-cie', title: 'Art & Design', description: 'Cambridge IGCSE Art & Design 0400 — painting, drawing, mixed media, graphic design, 3D studies, portfolio.', order_no: 17 },
  { id: 'subj-cie-global-persp', curriculum_id: 'curr-igcse-cie', title: 'Global Perspectives', description: 'Cambridge IGCSE Global Perspectives 0457 — research, analysis, collaboration, reflection, global topics.', order_no: 18 },
  { id: 'subj-cie-env-mgmt', curriculum_id: 'curr-igcse-cie', title: 'Environmental Management', description: 'Cambridge IGCSE Environmental Management 0680 — lithosphere, hydrosphere, atmosphere, biosphere, human impact.', order_no: 19 },
...
export const mockTopics: Topic[] = [
  ...
  // ── IGCSE CIE Chemistry (0620) ─────────────────────────────────────────────
  { id: 'top-cie-chem-1', subject_id: 'subj-cie-chemistry', title: 'States of Matter', description: 'Solids, liquids, gases, kinetic particle theory, diffusion, state changes.', syllabus_code: '1.1–1.2', learning_objectives: 'Describe the kinetic particle model for solids, liquids and gases. Explain state changes and diffusion in terms of particle motion.', order_no: 1 },
  { id: 'top-cie-chem-2', subject_id: 'subj-cie-chemistry', title: 'Atoms, Elements and Bonding', description: 'Atomic structure, periodic table, ionic and covalent bonding, metallic bonding, giant structures.', syllabus_code: '2.1–2.7', learning_objectives: 'Draw atomic structures for elements 1–20. Explain ionic, covalent and metallic bonding. Compare giant ionic, covalent, and metallic structures.', order_no: 2 },
  { id: 'top-cie-chem-3', subject_id: 'subj-cie-chemistry', title: 'Stoichiometry', description: 'Relative atomic mass, molar mass, mole calculations, empirical formula, percentage yield, titration.', syllabus_code: '3.1–3.4', learning_objectives: 'Calculate moles, mass and gas volumes. Determine empirical and molecular formulae. Perform titration calculations.', order_no: 3 },
  { id: 'top-cie-chem-4', subject_id: 'subj-cie-chemistry', title: 'Physical Chemistry', description: 'Energetics, rates of reaction, reversible reactions, equilibrium, redox, electrolysis.', syllabus_code: '4.1–5.1', learning_objectives: 'Calculate enthalpy changes. Explain factors affecting reaction rates. Describe electrolysis of molten and aqueous compounds.', order_no: 4 },
  { id: 'top-cie-chem-5', subject_id: 'subj-cie-chemistry', title: 'Inorganic & Organic Chemistry', description: 'Groups I & VII properties, transition metals, alkanes, alkenes, alcohols, carboxylic acids, polymers.', syllabus_code: '6.1–7.4', learning_objectives: 'Describe trends in Groups I and VII. Draw and name organic molecules. Explain addition polymerisation.', order_no: 5 },
  // ── IGCSE CIE Additional Mathematics (0606) ────────────────────────────────
  { id: 'top-cie-amath-1', subject_id: 'subj-cie-add-maths', title: 'Functions', description: 'Domain, range, inverse functions, composite functions, modulus, graph transformations.', syllabus_code: '1.1–1.6', learning_objectives: 'Find domain and range of functions. Determine inverse and composite functions. Sketch modulus functions and apply graph transformations.', order_no: 1 },
  { id: 'top-cie-amath-2', subject_id: 'subj-cie-add-maths', title: 'Quadratics and Inequalities', description: 'Completing the square, discriminant, quadratic inequalities, simultaneous equations, surds.', syllabus_code: '2.1–2.5', learning_objectives: 'Solve quadratic equations using discriminant. Solve quadratic and linear inequalities. Simplify surd expressions.', order_no: 2 },
  { id: 'top-cie-amath-3', subject_id: 'subj-cie-add-maths', title: 'Calculus', description: 'Differentiation, integration, stationary points, kinematics, area under curves.', syllabus_code: '3.1–3.6', learning_objectives: 'Differentiate polynomial, trig and exponential functions. Find maxima/minima. Integrate to find areas and solve kinematics problems.', order_no: 3 },
  { id: 'top-cie-amath-4', subject_id: 'subj-cie-add-maths', title: 'Trigonometry', description: 'Exact values, identities, solving trig equations, sine/cosine rules, radians, arc length & sector area.', syllabus_code: '4.1–4.6', learning_objectives: 'Solve trigonometric equations using identities. Apply sine and cosine rules. Calculate arc lengths and sector areas in radians.', order_no: 4 },
  // ── IGCSE CIE English First Language (0500) ────────────────────────────────
  { id: 'top-cie-efl-1', subject_id: 'subj-cie-english-fl', title: 'Reading Comprehension', description: 'Explicit and implicit meaning, writer\'s craft, language analysis, summary writing.', syllabus_code: 'R1–R4', learning_objectives: 'Identify explicit and implied meanings. Analyse the writer\'s use of language and structure. Write concise summaries.', order_no: 1 },
  { id: 'top-cie-efl-2', subject_id: 'subj-cie-english-fl', title: 'Directed Writing', description: 'Letters, reports, articles, speeches — adapting tone and register for purpose and audience.', syllabus_code: 'W1–W2', learning_objectives: 'Write for a specified audience and purpose. Use appropriate tone, register, and format. Develop arguments with supporting detail.', order_no: 2 },
  { id: 'top-cie-efl-3', subject_id: 'subj-cie-english-fl', title: 'Descriptive & Narrative Writing', description: 'Sensory detail, figurative language, structure, character, setting, atmosphere.', syllabus_code: 'W3–W4', learning_objectives: 'Use vivid sensory imagery and figurative language. Structure narratives with clear plot arcs. Create atmosphere through descriptive detail.', order_no: 3 },
  // ── IGCSE CIE English Literature (0486) ─────────────────────────────────────
  { id: 'top-cie-englit-1', subject_id: 'subj-cie-english-lit', title: 'Poetry Analysis', description: 'Form, structure, language, imagery, rhythm, rhyme, tone, context.', syllabus_code: 'P1–P2', learning_objectives: 'Analyse poetic form, structure and language. Explain the effect of imagery and sound devices. Relate poems to their contexts.', order_no: 1 },
  { id: 'top-cie-englit-2', subject_id: 'subj-cie-english-lit', title: 'Prose Study', description: 'Character, theme, setting, narrative voice, authorial techniques, context.', syllabus_code: 'P3–P4', learning_objectives: 'Analyse character development and themes. Evaluate narrative perspective and authorial techniques. Discuss social and historical contexts.', order_no: 2 },
  { id: 'top-cie-englit-3', subject_id: 'subj-cie-english-lit', title: 'Drama', description: 'Dialogue, stagecraft, dramatic irony, soliloquy, characterisation, themes.', syllabus_code: 'P5–P6', learning_objectives: 'Analyse dramatic dialogue and stage directions. Explain the function of soliloquy and dramatic irony. Discuss themes across acts.', order_no: 3 },
  { id: 'top-cie-englit-4', subject_id: 'subj-cie-english-lit', title: 'Unseen Texts', description: 'Close reading, annotation, comparative analysis, critical response under timed conditions.', syllabus_code: 'U1–U2', learning_objectives: 'Annotate unseen texts efficiently. Construct critical responses under time pressure. Compare two unseen passages.', order_no: 4 },
  // ── IGCSE CIE Business Studies (0450) ───────────────────────────────────────
  { id: 'top-cie-bs-1', subject_id: 'subj-cie-business', title: 'Business Activity and Organisation', description: 'Types of businesses, stakeholders, business objectives, enterprise, growth, multinationals.', syllabus_code: '1.1–1.5', learning_objectives: 'Compare sole traders, partnerships, companies and franchises. Explain stakeholder objectives. Evaluate business growth methods.', order_no: 1 },
  { id: 'top-cie-bs-2', subject_id: 'subj-cie-business', title: 'Marketing', description: 'Market research, marketing mix (4Ps), segmentation, product life cycle, e-commerce.', syllabus_code: '3.1–3.4', learning_objectives: 'Design market research. Apply the marketing mix. Analyse product life cycle stages. Evaluate e-commerce strategies.', order_no: 2 },
  { id: 'top-cie-bs-3', subject_id: 'subj-cie-business', title: 'Operations Management', description: 'Production methods, quality management, break-even analysis, location decisions, supply chain.', syllabus_code: '4.1–4.4', learning_objectives: 'Compare production methods. Calculate and interpret break-even. Evaluate quality assurance vs quality control.', order_no: 3 },
  { id: 'top-cie-bs-4', subject_id: 'subj-cie-business', title: 'Finance and Human Resources', description: 'Sources of finance, cash flow, income statements, balance sheets, ratios, recruitment, motivation.', syllabus_code: '2.1–2.4 & 5.1–5.4', learning_objectives: 'Analyse income statements and balance sheets. Calculate liquidity and profitability ratios. Evaluate recruitment and motivation methods.', order_no: 4 },
  // ── IGCSE CIE Accounting (0452) ─────────────────────────────────────────────
  { id: 'top-cie-acc-1', subject_id: 'subj-cie-accounting', title: 'The Fundamentals of Accounting', description: 'Double-entry bookkeeping, ledger accounts, trial balance, source documents, books of prime entry.', syllabus_code: '1.1–1.5', learning_objectives: 'Apply double-entry to record transactions. Prepare ledger accounts and a trial balance. Identify and correct errors.', order_no: 1 },
  { id: 'top-cie-acc-2', subject_id: 'subj-cie-accounting', title: 'Financial Statements', description: 'Income statements, balance sheets for sole traders, partnerships, limited companies, and clubs.', syllabus_code: '2.1–2.4', learning_objectives: 'Prepare income statements and balance sheets. Account for adjustments (accruals, prepayments, depreciation). Distinguish between entity types.', order_no: 2 },
  { id: 'top-cie-acc-3', subject_id: 'subj-cie-accounting', title: 'Analysis and Interpretation', description: 'Profitability ratios, liquidity ratios, efficiency ratios, inter-firm and trend comparisons.', syllabus_code: '3.1–3.2', learning_objectives: 'Calculate and interpret profitability, liquidity and efficiency ratios. Compare performance between businesses and over time.', order_no: 3 },
  { id: 'top-cie-acc-4', subject_id: 'subj-cie-accounting', title: 'Costing and Budgeting', description: 'Marginal costing, absorption costing, break-even, budgets, variance analysis.', syllabus_code: '4.1–4.3', learning_objectives: 'Distinguish marginal from absorption costing. Prepare cash budgets. Calculate and interpret variances.', order_no: 4 },
  // ── IGCSE CIE Geography (0460) ──────────────────────────────────────────────
  { id: 'top-cie-geo-1', subject_id: 'subj-cie-geography', title: 'Population and Settlement', description: 'Population dynamics, migration, settlement hierarchy, urbanisation, case studies.', syllabus_code: '1.1–1.7', learning_objectives: 'Describe and explain population growth patterns. Analyse causes and consequences of migration. Evaluate urbanisation in LEDCs and MEDCs.', order_no: 1 },
  { id: 'top-cie-geo-2', subject_id: 'subj-cie-geography', title: 'The Natural Environment', description: 'Plate tectonics, earthquakes, volcanoes, rivers, coasts, climate, ecosystems.', syllabus_code: '2.1–2.5', learning_objectives: 'Explain plate tectonic theory and associated hazards. Describe river and coastal landform processes. Compare climate types and biomes.', order_no: 2 },
  { id: 'top-cie-geo-3', subject_id: 'subj-cie-geography', title: 'Economic Development', description: 'Development indicators, agriculture, industry, tourism, energy, water, globalisation.', syllabus_code: '3.1–3.7', learning_objectives: 'Compare development indicators. Evaluate the impacts of tourism. Discuss the role of TNCs in globalisation. Assess energy and water resource management.', order_no: 3 },
  // ── IGCSE CIE History (0470) ────────────────────────────────────────────────
  { id: 'top-cie-hist-1', subject_id: 'subj-cie-history', title: 'The Cold War and US Containment', description: 'Origins of the Cold War, Yalta & Potsdam, Truman Doctrine, Marshall Plan, Berlin Blockade, Korean War, Cuban Missile Crisis, Vietnam War.', syllabus_code: 'Core 1', learning_objectives: 'Analyse the origins and key events of the Cold War. Evaluate US containment policies. Assess the causes and outcomes of conflicts in Korea, Cuba and Vietnam.', order_no: 1 },
  { id: 'top-cie-hist-2', subject_id: 'subj-cie-history', title: 'The Origins of WWII', description: 'Treaty of Versailles, League of Nations, appeasement, Nazi expansion, outbreak of war.', syllabus_code: 'Core 2', learning_objectives: 'Evaluate the impact of the Treaty of Versailles. Explain the failure of the League of Nations. Assess the policy of appeasement.', order_no: 2 },
  { id: 'top-cie-hist-3', subject_id: 'subj-cie-history', title: 'Source Analysis Skills', description: 'Evaluating provenance, cross-referencing, bias, utility, reliability, purpose.', syllabus_code: 'Skills', learning_objectives: 'Evaluate the reliability and utility of historical sources. Cross-reference multiple sources. Identify bias and purpose in historical documents.', order_no: 3 },
  // ── IGCSE CIE ICT (0417) ────────────────────────────────────────────────────
  { id: 'top-cie-ict-1', subject_id: 'subj-cie-ict', title: 'Hardware and Software', description: 'Input/output devices, storage, system vs application software, operating systems, emerging technologies.', syllabus_code: '1.1–1.4', learning_objectives: 'Describe types of hardware and storage media. Distinguish system from application software. Evaluate emerging technologies.', order_no: 1 },
  { id: 'top-cie-ict-2', subject_id: 'subj-cie-ict', title: 'Networks and Communications', description: 'LAN/WAN, topologies, protocols, internet, intranet, email, cybersecurity, data protection.', syllabus_code: '2.1–2.5', learning_objectives: 'Compare LAN and WAN. Describe network topologies and protocols. Explain cybersecurity threats and data protection laws.', order_no: 2 },
  { id: 'top-cie-ict-3', subject_id: 'subj-cie-ict', title: 'Data and Databases', description: 'Data types, validation, verification, database structure, queries, data protection act.', syllabus_code: '3.1–3.4', learning_objectives: 'Design validation and verification routines. Create and query databases. Explain the principles of the Data Protection Act.', order_no: 3 },
  { id: 'top-cie-ict-4', subject_id: 'subj-cie-ict', title: 'Applications and Systems Life Cycle', description: 'Word processing, spreadsheets, presentations, web authoring, systems analysis, design, testing, documentation.', syllabus_code: '4.1–4.6', learning_objectives: 'Use spreadsheet formulae and functions. Design and create web pages. Apply the systems life cycle to a project.', order_no: 4 },
  // ── IGCSE CIE French (0520) ─────────────────────────────────────────────────
  { id: 'top-cie-fr-1', subject_id: 'subj-cie-french', title: 'Listening and Reading', description: 'Comprehension of spoken and written French across everyday topics, gist and detail.', syllabus_code: 'Paper 1 & 2', learning_objectives: 'Understand main ideas and specific details in spoken and written French. Identify attitudes and opinions. Answer questions in English and French.', order_no: 1 },
  { id: 'top-cie-fr-2', subject_id: 'subj-cie-french', title: 'Speaking', description: 'Role play, topic presentation, general conversation on personal, social and cultural topics.', syllabus_code: 'Paper 3', learning_objectives: 'Conduct a role-play conversation. Deliver a prepared topic presentation. Engage in spontaneous conversation on familiar topics.', order_no: 2 },
  { id: 'top-cie-fr-3', subject_id: 'subj-cie-french', title: 'Writing and Grammar', description: 'Short and extended writing tasks, verb tenses, sentence structures, translation to French.', syllabus_code: 'Paper 4', learning_objectives: 'Write extended texts using a range of tenses. Translate sentences from English to French accurately. Apply complex grammatical structures.', order_no: 3 },
  // ── IGCSE CIE Spanish (0530) ────────────────────────────────────────────────
  { id: 'top-cie-es-1', subject_id: 'subj-cie-spanish', title: 'Listening and Reading', description: 'Comprehension of spoken and written Spanish across everyday and cultural topics.', syllabus_code: 'Paper 1 & 2', learning_objectives: 'Understand main ideas and specific details in spoken and written Spanish. Identify attitudes and opinions. Answer questions in English and Spanish.', order_no: 1 },
  { id: 'top-cie-es-2', subject_id: 'subj-cie-spanish', title: 'Speaking', description: 'Role play, topic presentation, general conversation on personal, social and cultural topics.', syllabus_code: 'Paper 3', learning_objectives: 'Conduct a role-play conversation. Deliver a prepared topic presentation. Engage in spontaneous conversation on familiar topics.', order_no: 2 },
  { id: 'top-cie-es-3', subject_id: 'subj-cie-spanish', title: 'Writing and Grammar', description: 'Short and extended writing tasks, verb tenses, sentence structures, translation to Spanish.', syllabus_code: 'Paper 4', learning_objectives: 'Write extended texts using a range of tenses. Translate sentences from English to Spanish accurately. Apply complex grammatical structures.', order_no: 3 },
  // ── IGCSE CIE Art & Design (0400) ───────────────────────────────────────────
  { id: 'top-cie-art-1', subject_id: 'subj-cie-art-design', title: 'Observational Drawing', description: 'Still life, figure drawing, perspective, tone, texture, mark-making, composition.', syllabus_code: 'AO1–AO2', learning_objectives: 'Draw accurately from observation. Demonstrate control of tone, texture and perspective. Compose effective visual arrangements.', order_no: 1 },
  { id: 'top-cie-art-2', subject_id: 'subj-cie-art-design', title: 'Painting and Mixed Media', description: 'Colour theory, acrylics, watercolour, collage, printmaking, layering, experimental techniques.', syllabus_code: 'AO2–AO3', learning_objectives: 'Apply colour theory in painting. Experiment with mixed media techniques. Develop personal visual language.', order_no: 2 },
  { id: 'top-cie-art-3', subject_id: 'subj-cie-art-design', title: 'Critical & Contextual Studies', description: 'Artist research, art movements, annotation, visual analysis, developing ideas.', syllabus_code: 'AO1 & AO4', learning_objectives: 'Research and analyse the work of relevant artists and movements. Annotate own work critically. Show development of ideas from research to final outcome.', order_no: 3 },
  // ── IGCSE CIE Global Perspectives (0457) ────────────────────────────────────
  { id: 'top-cie-gp-1', subject_id: 'subj-cie-global-persp', title: 'Research and Analysis Skills', description: 'Identifying research questions, evaluating sources, analysing perspectives, synthesising evidence.', syllabus_code: 'Component 1', learning_objectives: 'Formulate focused research questions. Evaluate the credibility of sources. Analyse differing perspectives and synthesise evidence into coherent arguments.', order_no: 1 },
  { id: 'top-cie-gp-2', subject_id: 'subj-cie-global-persp', title: 'Global Topics', description: 'Climate change, poverty and inequality, conflict and peace, biodiversity, health and disease, migration.', syllabus_code: 'Topics', learning_objectives: 'Explain causes and consequences of global issues. Analyse local, national and global perspectives on each topic. Propose evidence-based solutions.', order_no: 2 },
  { id: 'top-cie-gp-3', subject_id: 'subj-cie-global-persp', title: 'Collaboration and Reflection', description: 'Team project, group decision-making, peer evaluation, reflective writing.', syllabus_code: 'Component 2 & 3', learning_objectives: 'Collaborate effectively in a team to plan and execute a project. Reflect critically on personal and group learning. Deliver a clear group presentation.', order_no: 3 },
  // ── IGCSE CIE Environmental Management (0680) ───────────────────────────────
  { id: 'top-cie-em-1', subject_id: 'subj-cie-env-mgmt', title: 'The Lithosphere', description: 'Rock cycle, soil formation, mineral extraction, energy resources, sustainable mining.', syllabus_code: '1.1–1.5', learning_objectives: 'Describe the rock cycle and soil formation. Evaluate methods of mineral and energy extraction. Explain sustainable resource management.', order_no: 1 },
  { id: 'top-cie-em-2', subject_id: 'subj-cie-env-mgmt', title: 'The Hydrosphere and Atmosphere', description: 'Water cycle, water management, ocean resources, atmospheric composition, climate, weather, climate change.', syllabus_code: '2.1–2.5', learning_objectives: 'Explain the water cycle and water management strategies. Describe ocean resource uses. Analyse causes and impacts of climate change.', order_no: 2 },
  { id: 'top-cie-em-3', subject_id: 'subj-cie-env-mgmt', title: 'The Biosphere and Human Impact', description: 'Ecosystems, biodiversity, deforestation, agriculture, pollution, population growth, conservation.', syllabus_code: '3.1–3.5', learning_objectives: 'Describe major ecosystems and biodiversity threats. Evaluate agricultural impacts on the environment. Assess conservation strategies.', order_no: 3 },
...
export function createDeck(data: {
  ...
  const deck: Deck = {
    ...
    topic_id: (data as any).topic_id || null,
    name: data.name,
