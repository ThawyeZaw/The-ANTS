...
export const QUALIFICATION_REGISTRY: Record<QualificationKey, QualificationMeta> = {
  CAIE_IGCSE: {
    ...
    colorClass: 'text-blue-700 bg-blue-500/10',
    status: 'live',
  },
  Edexcel_IGCSE: {
    key: 'Edexcel_IGCSE',
  ...
  Edexcel_IAL: {
    ...
    colorClass: 'text-violet-700 bg-violet-500/10',
    status: 'live',
  },
  CAIE_AL: {
    key: 'CAIE_AL',
    ...
    colorClass: 'text-cyan-700 bg-cyan-500/10',
    status: 'live',
  },
  IELTS: {
    key: 'IELTS',
  ...
  OSSD: {
    ...
    colorClass: 'text-red-700 bg-red-500/10',
    status: 'soon',
  },
  GED: {
    key: 'GED',
