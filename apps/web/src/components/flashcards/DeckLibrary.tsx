    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-[var(--border)] bg-gradient-to-r from-violet-500/10 via-indigo-500/5 to-cyan-500/10 p-6 md:p-8">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-violet-500/10 px-3 py-1 text-xs font-semibold text-violet-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[var(--border)] pb-4">
        <div className="flex items-center gap-2 flex-wrap">
          <Link
            href="/flashcards"
            className="flex items-center gap-2 rounded-xl bg-violet-500/10 px-4 py-2 text-sm font-semibold text-violet-700 transition-all hover:bg-violet-500/20"
          >
